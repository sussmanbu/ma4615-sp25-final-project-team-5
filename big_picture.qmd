...
df_clean |> filter((Borough=="All") & (`Neighborhood (U.H.F)`=="All") & (SEX=="All") & (`RACE/ETHNICITY`!="All")) |> ggplot(aes(x = reorder(`RACE/ETHNICITY`, -`AIDS DIAGNOSES PER 100,000 POPULATION`), 
...
df_clean |> filter((Borough=="All") & (`Neighborhood (U.H.F)`=="All") & (SEX=="All") & (`RACE/ETHNICITY`!="All")) |> ggplot(aes(x = reorder(`RACE/ETHNICITY`, -`HIV DIAGNOSES PER 100,000 POPULATION`), 
...
df <- read_rds(here::here("dataset", "hiv_clean.rds"))
df_clean <- df |> 
  filter(is.finite(`TOTAL NUMBER OF HIV DIAGNOSES`) & (Borough=="All") & (`Neighborhood (U.H.F)`=="All") & (SEX=="All"))
ggplot(df_clean, aes(x = YEAR, y = `HIV DIAGNOSES PER 100,000 POPULATION`)) +
